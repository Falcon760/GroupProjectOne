...
namespace RecipeApplication.Controllers
{
    public class IngredientTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name")] IngredientType ingredientType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name")] IngredientType ingredientType)
        {
            if (ModelState.IsValid)
            {
