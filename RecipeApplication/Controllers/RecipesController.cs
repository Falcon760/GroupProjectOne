...
namespace RecipeApplication.Controllers
{
    public class RecipesController : Controller
    {
        ...
        {
            var recipes = db.Recipes.Include(r => r.Ingredient).Include(r => r.RecipeCategory);
        ...
        {
            ViewBag.Id = new SelectList(db.Ingredients, "Id", "Name");
        ...
        public ActionResult Create([Bind(Include = "Id,Name,RecipeCatId,RecipeDescription,PrepTime,CookTime,Procedures,IngredientId")] Recipe recipe)
        {
            ...
            ViewBag.Id = new SelectList(db.Ingredients, "Id", "Name", recipe.Id);
